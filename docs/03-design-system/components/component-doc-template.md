...
1. **Design & build** the component in Delta Labs (per [Design Principles](../design-principles)).
2. **Create** `docs/03-design-system/components/<component-name>.md` using the template above.
