...
- Obtain the token via your auth flow (e.g. login/register endpoints); see [Auth Context](/docs/overview/project-analysis#context-providers) in the project analysis.
