...
- **structure-guide.md** — Different tree: lists files that don’t exist (e.g. getting-started.md, 01-overview.md, 02-atomic-design.md), only 01–04, no 05/06/07.
...
**Verdict**: separation-guide adds unique value. No duplication. Its cross-reference *examples* pointed at old paths (typescript.md, component-library.md); those have been updated to real docs.
...
| Wrong overview URL | api-reference.md | Auth context link updated from `/docs/01-overview/...` to `/docs/overview/project-analysis#context-providers`. |
