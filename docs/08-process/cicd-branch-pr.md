...
- **CD:** On push to `main` — Vercel builds and deploys (see [Deployment Guide](/docs/deployment) or root `DEPLOYMENT.md`).
...
(Detailed CI/CD for backend is also in [Delta Labs System Architecture](/docs/05-architecture/full-system-architecture#73-cicd) §7.3.)
...
- [Delta Labs System Architecture](/docs/05-architecture/full-system-architecture) — §7.3 CI/CD, §7 Infrastructure
