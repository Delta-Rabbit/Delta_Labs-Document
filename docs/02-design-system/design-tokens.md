...
For the full token catalog and file locations, see [Project Analysis → Design Tokens](../01-overview/project-analysis.md#-design-system--theme).
...
- **Z-index**: Documented layers (e.g. tooltip, modal, overlay, dropdown) — see [Project Analysis](../01-overview/project-analysis.md#-design-system--theme).
...
- [Project Analysis → Design Tokens](../01-overview/project-analysis.md#-design-system--theme) — full token list and file paths.
- [Design System](./design-system.md) — components and atomic design.
- [Coding Standards → Styling](../03-coding-standards/coding-standards.md#8-styling-standards) — Tailwind and token usage rules.
