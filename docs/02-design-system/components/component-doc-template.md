...
(See [Design Tokens](../design-tokens.md) for the full set.)
...
- Other related components: [OtherComponent](./other-component.md)
```
...
1. **Design & build** the component in Delta Labs (per [Design System](../design-system.md)).
2. **Create** `docs/02-design-system/components/<component-name>.md` using the template above.
3. **Add** a row to the [Component Catalog](./component-catalog.md) table so it appears in the index.
